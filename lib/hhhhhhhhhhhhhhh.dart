...
class OrderMenu2 extends StatefulWidget {
   
  OrderMenu2({Key? key}) : super(key: key);

get l=> _OrderMenu2().fff;

 // get fff => l;
  
  @override
  State<OrderMenu2> createState() => _OrderMenu2();
  

}


class _OrderMenu2 extends State<OrderMenu2>{
     ...
     //alignment: Alignment.center,
                     ...
                     //////////////////////
                          ...
                          child:
                           ...
                           text:"User Name",
                              ...
                              children:<TextSpan>[
                                  TextSpan(
                                text:": aseel ",//${myCards[i]['User Name'].toString() }",
                                                  style:TextStyle(fontWeight:FontWeight.bold,
                                                  color:Color.fromARGB(255, 16, 14, 85),
                                                  fontSize: 17
                                                  ),
                           ...
                           Padding(padding: EdgeInsets.all(10)),
                              ...
                              children:<TextSpan>[
                                ...
                                text: " : 2-2-2022 ",//${myCards[i]['Date of order'].toString()}",
                                     style:TextStyle(
                           ...
                           text:  "Type Order",
                             ...
                             fontSize: 17
                              ...
                              children:<TextSpan>[
                                  TextSpan(
                                text:" : bnbvnbv ", // ${myCards[i]['Type Order'].toString()}",
                                     style:TextStyle(fontWeight:FontWeight.bold,
                                     color:Color.fromARGB(255, 16, 14, 85),
                                      fontSize: 17
                                     ),
        ...
        //             ),
                ...
                ////////**////////
                    ...
                    //funcListCurrent(myCards:lis[index].data );
    //  Obx(() {
...
text:"User Name",
   ...
   children:<TextSpan>[
       TextSpan(
     text:":  ${myCards[i]['User Name'].toString() }",
                       style:TextStyle(fontWeight:FontWeight.bold,
                       color:Color.fromARGB(255, 16, 14, 85),
                       fontSize: 17
                       ),
...
Padding(padding: EdgeInsets.all(10)),
   ...
   children:<TextSpan>[
     ...
     text: " :  ${myCards[i]['Date of order'].toString()}",
                                style:TextStyle(
                                  fontWeight:FontWeight.bold,
                                color: Color.fromARGB(255, 16, 14, 85),
                                 fontSize: 17
...
text:  "Type Order",
   ...
   children:<TextSpan>[
       TextSpan(
     text:" :    ${myCards[i]['Type Order'].toString()}",
                                style:TextStyle(fontWeight:FontWeight.bold,
                                color:Color.fromARGB(255, 16, 14, 85),
                                 fontSize: 17
                                ),
