...
class DeleteActivityServices {
  var token;

  late SecureStorage secureStorage = SecureStorage();
  Future<bool> deleteActivity(int idActivity) async {
    var url = Uri.parse(baseUrl + deleteActivityRoute + '$idActivity');
    ...
    if (response.statusCode == 200) {
      ...
      // var r = response.body;
      print("idActivity is ---> $idActivity");
      // print("r is ---> $r");
      print(map['data']);
