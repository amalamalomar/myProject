...
class UnAcceptableOrder extends StatefulWidget {
  UnAcceptableOrder({Key? key}) : super(key: key);
  
  @override
  State<UnAcceptableOrder> createState() => _UnAcceptableOrder();
  
}


class _UnAcceptableOrder extends State<UnAcceptableOrder>{
      ...
      ListTile(
          ...
          body: FutureBuilder<CurrentActivCardModel>(
             ...
             //   Text("${snapshot.data!.data}")
              ListUnAcceptOrder(myCards: snapshot.data!.data)
...
class ListUnAcceptOrder extends StatelessWidget{
  List myCards=[];
  ListUnAcceptOrder({required this.myCards});
  @override
  Widget build(BuildContext context) {
